...
CREATE TABLE `tb_code_show` (
    `id` INT(20) NOT NULL AUTO_INCREMENT COMMENT '主键数据库内唯一id',
  `code_id` varchar(100) NOT NULL DEFAULT '' COMMENT '灾情代码',
...
insert  into `tb_code_show`(`id`,`code_id`,`province`,`PL_city`,`district`,`town`,`community`,`username`,`source`,`supporter`,`disaster_info`,`is_deleted`,`is_file`,`code_status`) values (1,'10000001','北京市','市辖区','东城区','东华门街道','多福巷社区居委会','Zhou','业务报送数据 - 前方地震应急指挥部','文字','震情-震情信息-地理位置',0,0,1);
insert  into `tb_code_show`() values (1,'10011001','北京市','市辖区','东城区','东华门街道','多福巷社区居委会','Zhou','业务报送数据 - 前方地震应急指挥部','文字','震情-震情信息-地理位置',0,0,1);